...
<head>
    ...
    <title>Lanche Dus Mininu - Cadastro</title>
...
<body>
<a class="btn-voltar" href="{{ route('login') }}">
...
<!-- <button class="btn-voltar" onclick="window.location.href='index.php'">
 ...
 <div class="container">
        ...
        <h2 class="teste">Bem vindo!</h2>
        <p>Já possui uma conta? Faça login!</p>
        <a class="btn-outline" href="{{ route('login') }}">
            <i class="fa fa-arrow-left"></i> ENTRAR
        </a>
       <!-- <button type="button" class="btn-outline" onclick="window.location.href='login.php'">ENTRAR</button> -->
